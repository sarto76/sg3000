...
@section('content')
    ...
    <div class="container" id="main-wrapper">
        ...
        <div class="row">
                            ...
                            <div class="tab-pane" id="tab2" role="tabpanel">
                                <div class="table-responsive">
                                    @if (count($member->licenses) > 0)
                                        <table class="table">
                                            <tr>
                                                <th scope="row" colspan="2">{{__('member.licenses')}}</th>
                                            </tr>
                                            @foreach($member->licenses as $license)
                                                <tr>
                                                    <td>{{$license->license_type_id}}</td>
                                                    <td>{{$license->pivot->valid_from}}</td>
                                                </tr>
                                            @endforeach
                                        </table>
                                    @else
            ...
            <a href="{{ url()->previous() }}"class="btn btn-default"><i class="fa fa-angle-left"></i> Torna indietro</a>
        </div>
    </div>
